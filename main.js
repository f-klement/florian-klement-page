(function () {
  ...
  const t = {
    en: {
      ...
      "skill.web.desc":     "Full-stack applications from database to user interface, including cross-platform mobile development with Ionic.",
    ...
    de: {
      ...
      "skill.web.desc":     "Full-Stack-Anwendungen von der Datenbank bis zur Oberfläche, einschließlich plattformübergreifender mobiler Apps mit Ionic.",
